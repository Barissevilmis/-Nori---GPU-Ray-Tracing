...
namespace nori{
    ...
    template <typename Scalar, int Dimension>  struct TVectorGPU;
    template <typename Scalar, int Dimension>  struct TPointGPU;
    template <typename Point, typename Vector> struct TRayGPU;
    template <typename Point>                  struct TBoundingBox;
    template <typename Point>                  struct TBoundingBoxGPU;
    ...
    ////////GPU versions of the abstractions//////////
    typedef TVectorGPU<float, 1>       VectorGPU1f;
    typedef TVectorGPU<float, 2>       VectorGPU2f;
    typedef TVectorGPU<float, 3>       VectorGPU3f;
    typedef TVectorGPU<float, 4>       VectorGPU4f;
    typedef TVectorGPU<double, 1>      VectorGPU1d;
    typedef TVectorGPU<double, 2>      VectorGPU2d;
    typedef TVectorGPU<double, 3>      VectorGPU3d;
    typedef TVectorGPU<double, 4>      VectorGPU4d;
    typedef TVectorGPU<int, 1>         VectorGPU1i;
    typedef TVectorGPU<int, 2>         VectorGPU2i;
    typedef TVectorGPU<int, 3>         VectorGPU3i;
    typedef TVectorGPU<int, 4>         VectorGPU4i;


    typedef TPointGPU<float, 1>        PointGPU1f;
    typedef TPointGPU<float, 2>        PointGPU2f;
    typedef TPointGPU<float, 3>        PointGPU3f;
    typedef TPointGPU<float, 4>        PointGPU4f;
    typedef TPointGPU<double, 1>       PointGPU1d;
    typedef TPointGPU<double, 2>       PointGPU2d;
    typedef TPointGPU<double, 3>       PointGPU3d;
    typedef TPointGPU<double, 4>       PointGPU4d;
    typedef TPointGPU<int, 1>          PointGPU1i;
    typedef TPointGPU<int, 2>          PointGPU2i;
    typedef TPointGPU<int, 3>          PointGPU3i;
    typedef TPointGPU<int, 4>          PointGPU4i;


    typedef TBoundingBoxGPU<PointGPU1f>   BoundingBoxGPU1f;
    typedef TBoundingBoxGPU<PointGPU2f>   BoundingBoxGPU2f;
    typedef TBoundingBoxGPU<PointGPU3f>   BoundingBoxGPU3f;
    typedef TBoundingBoxGPU<PointGPU4f>   BoundingBoxGPU4f;
    typedef TBoundingBoxGPU<PointGPU1d>   BoundingBoxGPU1d;
    typedef TBoundingBoxGPU<PointGPU2d>   BoundingBoxGPU2d;
    typedef TBoundingBoxGPU<PointGPU3d>   BoundingBoxGPU3d;
    typedef TBoundingBoxGPU<PointGPU4d>   BoundingBoxGPU4d;
    typedef TBoundingBoxGPU<PointGPU1i>   BoundingBoxGPU1i;
    typedef TBoundingBoxGPU<PointGPU2i>   BoundingBoxGPU2i;
    typedef TBoundingBoxGPU<PointGPU3i>   BoundingBoxGPU3i;
    typedef TBoundingBoxGPU<PointGPU4i>   BoundingBoxGPU4i;

    typedef TRayGPU<PointGPU2f, VectorGPU2f> RayGPU2f;
    typedef TRayGPU<PointGPU3f, VectorGPU3f> RayGPU3f;
    ///////////////////////////////////////
    ...
    extern VectorGPU3f sphericalDirection(float theta, float phi);

    /// Compute a direction for the given coordinates in spherical coordinates
    extern PointGPU2f sphericalCoordinates(const VectorGPU3f &dir);
