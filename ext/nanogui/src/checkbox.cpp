...
bool CheckBox::mouse_button_event(const VectorGPU2i &p, int button, bool down,
                                int modifiers) {
...
VectorGPU2i CheckBox::preferred_size(NVGcontext *ctx) const {
    if (m_fixed_size != VectorGPU2i(0))
        return m_fixed_size;
