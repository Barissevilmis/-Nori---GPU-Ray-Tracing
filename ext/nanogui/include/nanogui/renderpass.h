...
public:
    ...
    void set_viewport(const VectorGPU2i &offset, const VectorGPU2i &size);

    /// Return the pixel offset and size of the viewport region
    std::pair<VectorGPU2i, VectorGPU2i> viewport() {
    ...
    void resize(const VectorGPU2i &size);
...
protected:
    ...
    VectorGPU2i m_viewport_offset;
    VectorGPU2i m_viewport_size;
    VectorGPU2i m_framebuffer_size;
