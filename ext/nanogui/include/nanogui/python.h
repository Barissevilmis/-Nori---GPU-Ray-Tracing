...
#define NANOGUI_WIDGET_OVERLOADS(Parent) \
    bool mouse_button_event(const ::nanogui::VectorGPU2i &p, int button, bool down, int modifiers) override { \
        PYBIND11_OVERLOAD(bool, Parent, mouse_button_event, p, button, down, modifiers); \
    } \
    bool mouse_motion_event(const ::nanogui::VectorGPU2i &p, const ::nanogui::VectorGPU2i &rel, int button, int modifiers) override { \
        PYBIND11_OVERLOAD(bool, Parent, mouse_motion_event, p, rel, button, modifiers); \
    } \
    bool mouse_drag_event(const ::nanogui::VectorGPU2i &p, const ::nanogui::VectorGPU2i &rel, int button, int modifiers) override { \
        PYBIND11_OVERLOAD(bool, Parent, mouse_drag_event, p, rel, button, modifiers); \
    } \
    bool mouse_enter_event(const ::nanogui::VectorGPU2i &p, bool enter) override { \
        PYBIND11_OVERLOAD(bool, Parent, mouse_enter_event, p, enter); \
    } \
    bool scroll_event(const ::nanogui::VectorGPU2i &p, const ::nanogui::VectorGPU2f &rel) override { \
    ...
    ::nanogui::VectorGPU2i preferred_size(NVGcontext *ctx) const override { \
        PYBIND11_OVERLOAD(::nanogui::VectorGPU2i, Parent, preferred_size, ctx); \
    } \
...
#define NANOGUI_LAYOUT_OVERLOADS(Parent) \
    ::nanogui::VectorGPU2i preferred_size(NVGcontext *ctx, const ::nanogui::Widget *widget) const override { \
        PYBIND11_OVERLOAD(::nanogui::VectorGPU2i, Parent, preferred_size, ctx, widget); \
    } \
...
#define NANOGUI_SCREEN_OVERLOADS(Parent) \
    ...
    virtual bool resize_event(const ::nanogui::VectorGPU2i &size) override { \
