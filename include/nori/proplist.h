...
namespace nori{
    ...
    public:
        ...
        void setColor(const std::string &name, const ColorGPU3f &value);

        /// Get a color property, and throw an exception if it does not exist
        ColorGPU3f getColor(const std::string &name) const;

        /// Get a color property, and use a default value if it does not exist
        ColorGPU3f getColor(const std::string &name, const ColorGPU3f &defaultValue) const;

        /// Set a point property
        void setPoint(const std::string &name, const PointGPU3f &value);

        /// Get a point property, and throw an exception if it does not exist
        PointGPU3f getPoint(const std::string &name) const;

        /// Get a point property, and use a default value if it does not exist
        PointGPU3f getPoint(const std::string &name, const PointGPU3f &defaultValue) const;

        /// Set a vector property
        void setVector(const std::string &name, const VectorGPU3f &value);

        /// Get a vector property, and throw an exception if it does not exist
        VectorGPU3f getVector(const std::string &name) const;

        /// Get a vector property, and use a default value if it does not exist
        VectorGPU3f getVector(const std::string &name, const VectorGPU3f &defaultValue) const;
    ...
    private:
        ...
        struct Property {
            ...
            struct Value
            {
                ...
                ColorGPU3f color_value;
                PointGPU3f point_value;
                VectorGPU3f vector_value;
