...
public:
    ExampleApplication() : Screen(VectorGPU2i(1024, 768), "NanoGUI Test") {
        inc_ref();
        Window *window = new Window(this, "Button demo");
        window->set_position(VectorGPU2i(15, 15));
        ...
        window->set_position(VectorGPU2i(200, 15));
        window->set_layout(new GroupLayout());
        ...
        popup->set_fixed_size(VectorGPU2i(245, 150));

        auto image_window = new Window(this, "Selected image");
        image_window->set_position(VectorGPU2i(710, 15));
        ...
        image_view->set_pixel_callback(
            [this](const VectorGPU2i& index, char **out, size_t size) {
        ...
        text_box->set_fixed_size(VectorGPU2i(60, 25));
        ...
        window->set_position(VectorGPU2i(425,15));
        window->set_layout(new GroupLayout());
        ...
        b->set_fixed_size(VectorGPU2i(22, 22));
        ...
        window->set_position(VectorGPU2i(425, 300));
        GridLayout *layout =
        ...
        /* FP widget */ {
            ...
            text_box->set_fixed_size(VectorGPU2i(100, 20));
            text_box->set_value("50");
        ...
        /* Positive integer widget */ {
            ...
            int_box->set_fixed_size(VectorGPU2i(100, 20));
        ...
        cobo->set_fixed_size(VectorGPU2i(100,20));
        ...
        layout->set_spacing(0, 10);
        window->set_layout(layout);
        window->set_position(VectorGPU2i(425, 500));
    ...
    virtual void draw_contents() {
        Matrix4f mvp = Matrix4f::scale(VectorGPU3f(
                           (float) m_size.y() / (float) m_size.x() * 0.25f, 0.25f, 0.25f)) *
                       Matrix4f::rotate(VectorGPU3f(0, 0, 1), (float) glfwGetTime());
