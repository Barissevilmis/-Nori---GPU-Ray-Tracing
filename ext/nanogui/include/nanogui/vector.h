...
template <typename Value_, size_t Size_> struct Array {
    ...
    template <typename T,std::enable_if_t<T::Size == Size && std::is_same_v<typename T::Value, Value>, int> = 0>
    Array(const T &a) {
...
using VectorGPU2f     = Array<float, 2>;
using VectorGPU3f     = Array<float, 3>;
using VectorGPU4f     = Array<float, 4>;
using VectorGPU2i     = Array<int32_t, 2>;
using VectorGPU3i     = Array<int32_t, 3>;
using VectorGPU4i     = Array<int32_t, 4>;
 ...
 * \endrst
 */
class Color : public VectorGPU4f {
public:
    using VectorGPU4f::VectorGPU4f;
    using VectorGPU4f::operator=;

    /// Default constructor: represents black (``r, g, b, a = 0``)
    Color() : Color(0, 0, 0, 0) { }

    /// Initialize from a 4D vector
    Color(const VectorGPU4f &color) : VectorGPU4f(color) { }
     ...
     */
    Color(const VectorGPU3f &color, float alpha)
        : Color(color[0], color[1], color[3], alpha) { }
     ...
     */
    Color(const VectorGPU3i &color, int alpha)
        : Color(VectorGPU3f(color) / 255.f, alpha / 255.f) { }
     ...
     * The three dimensional float vector being copied.
     */
    Color(const VectorGPU3f &color) : Color(color, 1.0f) {}
     ...
     * The three dimensional integer vector being copied, will be divided by ``255.0``.
     */
    Color(const VectorGPU3i &color)
        : Color(VectorGPU3f(color) / 255.f, 1.f) { }
     ...
     * The three dimensional integer vector being copied, will be divided by ``255.0``.
     */
    Color(const VectorGPU4i &color)
        : Color(VectorGPU4f(color) / 255.f) { }
    ...
    Color(float intensity, float alpha)
        : Color(VectorGPU3f(intensity), alpha) { }
    ...
    Color(int intensity, int alpha)
        : Color(VectorGPU3i(intensity), alpha) { }
     ...
     * The alpha component of the color.
     */
    Color(float r, float g, float b, float a) : Color(VectorGPU4f(r, g, b, a)) { }
     ...
     * The alpha component of the color, will be divided by ``255.0``.
     */
    Color(int r, int g, int b, int a) : Color(VectorGPU4f((float) r, (float) g, (float) b, (float) a) / 255.f) { }
