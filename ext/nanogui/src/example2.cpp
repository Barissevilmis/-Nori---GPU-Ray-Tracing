...
int main(int /* argc */, char ** /* argv */) {
    ...
    /* scoped variables */ {
        ...
        if (use_gl_4_1) {
            ...
            screen = new Screen(VectorGPU2i(500, 700), "NanoGUI test [GL 4.1]",
                                /* resizable */ true, /* fullscreen */ false,
                                /* depth_buffer */ true, /* stencil_buffer */ true,
                                /* float_buffer */ false, /* gl_major */ 4,
                                /* gl_minor */ 1);
        } else {
            screen = new Screen(VectorGPU2i(500, 700), "NanoGUI test");
        }

        bool enabled = true;
        FormHelper *gui = new FormHelper(screen);
        ref<Window> window = gui->add_window(VectorGPU2i(10, 10), "Form helper example");
