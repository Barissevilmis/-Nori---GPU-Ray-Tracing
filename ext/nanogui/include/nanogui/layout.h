...
public:
     ...
     *     for icons, etc.
     */
    virtual VectorGPU2i preferred_size(NVGcontext *ctx, const Widget *widget) const = 0;
protected:
...
public:
    ...
    virtual VectorGPU2i preferred_size(NVGcontext *ctx, const Widget *widget) const override;
