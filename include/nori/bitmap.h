...
namespace nori{
     ...
     */
    class Bitmap : public Eigen::Array<ColorGPU3f, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> {
    public:
        typedef Eigen::Array<ColorGPU3f, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Base;
         ...
         */
        Bitmap(const VectorGPU2i &size = VectorGPU2i(0, 0))
            : Base(size.y(), size.x()) { }
