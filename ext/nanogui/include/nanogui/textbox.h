...
public:
    ...
    virtual bool mouse_enter_event(const VectorGPU2i &p, bool enter) override;
    virtual bool mouse_button_event(const VectorGPU2i &p, int button, bool down, int modifiers) override;
    virtual bool mouse_motion_event(const VectorGPU2i &p, const VectorGPU2i &rel, int button, int modifiers) override;
    virtual bool mouse_drag_event(const VectorGPU2i &p, const VectorGPU2i &rel, int button, int modifiers) override;
    ...
    virtual VectorGPU2i preferred_size(NVGcontext *ctx) const override;
...
protected:
    ...
    SpinArea spin_area(const VectorGPU2i &pos);
...
protected:
    ...
    int m_cursor_pos;
    int m_selection_pos;
    VectorGPU2i m_mouse_pos;
    VectorGPU2i m_mouse_down_pos;
    VectorGPU2i m_mouse_drag_pos;
...
public:
    ...
    virtual bool mouse_button_event(const VectorGPU2i &p, int button, bool down,
    ...
    virtual bool mouse_drag_event(const VectorGPU2i &p, const VectorGPU2i &rel, int button,
                                  int modifiers) override {
    ...
    virtual bool scroll_event(const VectorGPU2i &p, const VectorGPU2f &rel) override {
