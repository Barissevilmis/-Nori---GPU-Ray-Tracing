...
protected:
    VectorGPU2i position_to_block(const VectorGPU2i &pos) const;
    VectorGPU2i block_to_position(const VectorGPU2i &pos) const;
...
protected:
    ...
    std::string m_font;
    VectorGPU2i m_offset, m_max_size;
    int m_padding;
    bool m_selectable;
    VectorGPU2i m_selection_start;
    VectorGPU2i m_selection_end;
};
